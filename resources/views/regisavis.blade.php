                ...
                <form method="POST" action="/guardaravistamiento" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-floating">
                            <textarea class="form-control @error('informacion') is-invalid @enderror" name="informacion" id="informacion" placeholder="Leave a comment here" style="height: 100px">{{ old('informacion') }}</textarea>
